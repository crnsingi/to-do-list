    ...
    <div className="min-h-screen flex flex-col bg-[#374151] text-[#EEE] font-sans">
      ...
      <header className="p-8 max-w-2xl w-full mx-auto">
        ...
        <form className="flex" onSubmit={addTask}>
          ...
          <button
            type="submit"
            className="text-[1.25rem] font-bold bg-linear-to-r from-[#EC4899] to-[#8B5CF6] bg-clip-text text-transparent transition-opacity duration-300 hover:opacity-80 active:opacity-60"
          >
            Add task
          </button>
        </form>
              ...
              >
                ...
                <div className="flex -mx-2">
                  <button
                    ...
                    className="mx-2 text-[1.125rem] font-bold uppercase bg-linear-to-r from-[#EC4899] to-[#8B5CF6] bg-clip-text text-transparent transition-opacity duration-300 hover:opacity-80 active:opacity-60"
                  >
